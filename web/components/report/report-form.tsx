...
export function ReportForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
      ...
      <div className="clay-card p-4.5 sm:p-6 md:p-8 space-y-4 sm:space-y-5 border-white/5">
          ...
          {Object.entries(ISSUE_CATEGORIES).map(([key, config]) => {
            ...
            return (
              <button
                ...
                className={`p-3 sm:p-4 rounded-2xl text-left transition-all duration-200 flex flex-col justify-between gap-2.5 sm:gap-3 cursor-pointer min-h-[110px] ${isSelected
              ...
              >
                <div
                  className={`w-9 h-9 sm:w-10 sm:h-10 rounded-xl sm:rounded-2xl flex items-center justify-center transition-transform shrink-0 ${isSelected
                ...
                <div>
                  <h4 className="font-bold text-xs sm:text-sm leading-tight text-white mb-0.5 sm:mb-1">
                    {config.label}
                  </h4>
      ...
      <div className="clay-card p-4.5 sm:p-6 md:p-8 space-y-5 sm:space-y-6 border-white/5">
        <div className="flex items-center gap-2.5 pb-3 border-b border-white/5">
          <h3 className="text-base sm:text-lg font-bold text-white tracking-tight">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className={`h-11 sm:h-12 text-sm sm:text-base ${errors.title ? "border-red-500/60 focus:ring-red-500" : ""}`}
          />
          {errors.title && (
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            className={`text-sm sm:text-base ${errors.description ? "border-red-500/60 focus:ring-red-500" : ""}`}
          />
          {errors.description && (
      ...
      <div className="clay-card p-4.5 sm:p-6 md:p-8 space-y-4 border-white/5">
        <div className="flex items-center gap-2.5 pb-3 border-b border-white/5">
          <h3 className="text-base sm:text-lg font-bold text-white tracking-tight">
      ...
      <div className="pt-2">
        <Button
          ...
          variant="default"
          size="lg"
          className="w-full h-13 sm:h-14 text-base font-bold gap-3 shadow-xl shadow-amber-500/25 rounded-2xl min-h-[48px]"
        >
          {isPending ? (
            <>
